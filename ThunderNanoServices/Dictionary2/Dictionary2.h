...
namespace Plugin {
    ...
    class Dictionary2 : public PluginHost::IPlugin, public PluginHost::JSONRPC, public Exchange::IDictionary {
    public:
        Dictionary2(const Dictionary2&) = delete;
        Dictionary2& operator=(const Dictionary2&) = delete;
        Dictionary2(Dictionary2&&) = delete;
        Dictionary2& operator=(Dictionary2&&) = delete;
    ...
    public:
        ...
        BEGIN_INTERFACE_MAP(Dictionary2)
