...
namespace Plugin {
    ...
    class Dictionary3 : public PluginHost::IPlugin, public PluginHost::JSONRPC, public Exchange::IDictionary {
    public:
        Dictionary3(const Dictionary3&) = delete;
        Dictionary3& operator=(const Dictionary3&) = delete;
        Dictionary3(Dictionary3&&) = delete;
        Dictionary3& operator=(Dictionary3&&) = delete;
    ...
    public:
        ...
        BEGIN_INTERFACE_MAP(Dictionary3)
